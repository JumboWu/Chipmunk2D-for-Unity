...
namespace X.Engine
{
	...
	public class cp
	{
        ...
        public const float M_Deg2Rad = 0.01745329251994329577f;
        public const float M_Rad2Deg = 57.29577951308232087684f;
        ...
        //
        public static float cpfangle(float radian)
        {
            return M_Rad2Deg * radian;
        }

        public static float cpfradian(float angle)
        {
            return angle * M_Deg2Rad;
        }
