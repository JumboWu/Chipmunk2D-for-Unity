...
namespace X.Engine
{
    ...
    public delegate bool cpCollisionBeginFunc(cpArbiter arbiter, cpSpace space, object userData);
    /// Collision pre-solve event function callback type.
    /// Returning false from a pre-step callback causes the collision to be ignored until the next step.
    public delegate bool cpCollisionPreSolveFunc(cpArbiter arbiter, cpSpace space, object userData);
    /// Collision post-solve event function callback type.
    public delegate  void cpCollisionPostSolveFunc(cpArbiter arb, cpSpace space, object userData);
    /// Collision separate event function callback type.
    public delegate void cpCollisionSeparateFunc(cpArbiter arb, cpSpace space, object userData);
