...
namespace X.Engine
{
    public delegate ulong cpSpatialIndexQueryFunc(object obj1, object obj2, ulong collideID, object data);
    public delegate float cpSpatialIndexSegmentQueryFunc(object obj1, object obj2, object data);
    public delegate cpVect cpBBTreeVelocityFunc(object obj);//This function should return an estimate for the object's velocity. 
    public delegate bool cpHashSetFilterFunc(object elt, object data);
	...
	*/
	...
	public class cpBBTree
	{
        ...
        public cpBBTreeVelocityFunc velocityFunc { get; set; }
        ...
        public void SetFilter(cpHashSetFilterFunc func, object data)
		{
